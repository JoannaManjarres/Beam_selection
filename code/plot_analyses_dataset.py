...
def plot_samples(dataset_s008, dataset_s009):
    ...
    plt.plot(mean_episodes, mean_s008, '-o', label='Mean s008', color='blue')
    plt.plot (mean_episodes, mean_s009, '-o', label='Mean s009', color='orange')
    plt.xlabel ('episodes')
    ...
    plt.legend ()
    plt.savefig( '../analyses/mean_samples_by_episode.png', dpi=300)
    plt.close ()
